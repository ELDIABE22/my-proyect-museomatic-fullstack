...
const CardTicketsSold = ({ ticketSale, searchTicketSale }) => {
  return (
    <Card className="max-w-[350px] w-full">
      ...
      <CardBody>
        <p className="text-center font-bold text-2xl">
          {ticketSale?.total_cantidad_tickets ||
            searchTicketSale?.total_cantidad_tickets ||
            0}
        </p>
      </CardBody>
    </Card>
...
export default CardTicketsSold;
